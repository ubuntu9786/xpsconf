...
theme.wallpaper                                 = os.getenv("HOME") .. "/Pictures/Wallpapers/ubuntu15.04-wallpaper.jpg"
...
theme.border_normal                             = "#EBEBEB"
theme.border_focus                              = "#EBEBEB"
theme.border_marked                             = "#CC9393"
theme.titlebar_bg_focus                         = "#3F3F3F30"
theme.titlebar_bg_normal                        = "#3F3F3F30"
